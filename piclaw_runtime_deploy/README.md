...
- `comms/telegram.js` — Telegram bot (/status, /whoami, /setup, etc.)

Full directory tree and module map: **docs/audit/00_tree.md**. Deploy and identity: **DEPLOY.md**. When you add or remove modules or change the layout, update `docs/audit/00_tree.md` (and related audit docs) so the code and docs stay in sync.

Dependencies: `node-telegram-bot-api`, `systeminformation`, `express`.
